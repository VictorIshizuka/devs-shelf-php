...
class Validation
{
        ...
        foreach ($rules as $field => $rulesField) {
            ...
            foreach ($rulesField as $rule) {
                ...
                if ($rule == 'confirmed') {
                    ...
                    $validation->$rule($field, $valueField, $data["{$field}confirmed"]);
    ...
    private function email($field, $value)
    {
        ...
        if (! filter_var($value, FILTER_VALIDATE_EMAIL)) {
            ...
            $this->validations[] = "O campo $field é inválido.";
        }
    }
    ...
    private function confirmed($field, $value, $valueConfirmed)
    {
        ...
        if ($value != $valueConfirmed) {
            ...
            $this->validations[] = "O campo $field de confirmação está diferente.";
        }
    }
    ...
    private function unique($table, $field, $value)
    {
        ...
        if ($result) {
            ...
            $this->validations[] = "O campo $field já está sendo usado.";
        }
    }
    ...
    private function min($min, $field, $value)
    {
        ...
        if (strlen($value) <= $min) {
            ...
            $this->validations[] = "O campo $field precisa ter um mínimo de $min caracteres.";
        }
    }
    ...
    private function max($max, $field, $value)
    {
        ...
        if (strlen($value) > $max) {
            ...
            $this->validations[] = "O cmapo $field precisa ter um máximo de $max caracteres.";
        }
    }
    ...
    private function strong($field, $value)
    {
        ...
        if (! strpbrk($value, "!#$%&'()*+,-./:;<=>?@[\]^_`{|}~")) {
            ...
            $this->validations[] = "O campo $field precisa de um caractere especial.";
        }
    }
